...
export const Banner: React.FC = () => {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-700 via-indigo-700 to-purple-600 p-5 sm:p-8 text-white shadow-lg shadow-purple-950/10 border border-purple-400/20">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-5 sm:gap-6">
        <div>
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/15 backdrop-blur-md text-[10px] sm:text-[11px] font-semibold text-purple-100 tracking-wide mb-2 sm:mb-3 border border-white/20">
          ...
          <p className="text-xs sm:text-sm md:text-base text-purple-100/90 max-w-xl font-normal leading-relaxed">
            {isAdmin
          ...
          {isAdmin ? (
            <div className="grid grid-cols-3 sm:flex sm:flex-wrap items-center gap-2 sm:gap-3">
              <button
                ...
                className="flex items-center justify-center gap-1.5 px-2 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-purple-900/60 hover:bg-purple-900 text-white font-semibold text-[11px] sm:text-xs md:text-sm backdrop-blur-md border border-purple-400/40 shadow-sm transition-all hover:scale-102 active:scale-98 cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-1.5 px-2 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-white/15 hover:bg-white/25 text-white font-semibold text-[11px] sm:text-xs md:text-sm backdrop-blur-md border border-white/20 shadow-sm transition-all hover:scale-102 active:scale-98 cursor-pointer"
              >
                <Boxes className="w-3.5 h-3.5 text-purple-200 shrink-0" />
              ...
              >
                ...
                <span className="truncate">Manage Due</span>
              </button>
            </div>
          ) : (
